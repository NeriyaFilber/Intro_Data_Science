...
def print_data(averages, iris_standard_deviations, iris_name):
    print("\n\nAll data for " + iris_name + ":\n")
    print("The average of septal length is: " + str(averages[0]))
    print("The average of sepal width is: " + str(averages[1]))
    print("The average of petal length is: " + str(averages[2]))
    print("The average of petal width is: " + str(averages[3]) + "\n")
...
if __name__ == '__main__':
    file_dir ="iris.csv"  # Implement file path here.
    file_data = file_to_data(file_dir)
    iris_splited_data = file_to_list(file_data)

    iris_names = ["Iris Setosa", "Iris Versicolor", "Iris Virginica"]
    # calculate averages
    iris_averages = calculate_averages(iris_splited_data)
    # calculate standard deviation
    iris_standard_deviation = calculate_standards_deviations(iris_splited_data, iris_averages)

    # print the data of averages and standard deviation
    print_data(iris_averages, iris_standard_deviation, "Iris's")
